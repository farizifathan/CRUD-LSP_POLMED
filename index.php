...
<html lang="en">
  <head>
    ...
    <title> Polmed Sistem Informasi Akademik  </title>
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <center>
            &nbsp; <a href="index.php" class="fa fa-mortar-board fa-2x" style="color:#fff;"><span><font size="4.95" color="white" face="Helvetica Neue">APK AKADEMIK</font></span></a>
            </center>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" >
                  <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="assets/images/image.jpg" alt="">Farizi Fathan Pane
                  </a>
                  <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item"  href="#"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                     <a> <button onclick="toggleDarkMode()">Change</button>
                         <p id="themeInfo">Light!</p></a>
                  </div>
                </li>
              </ul>
            </nav>
      ...
      switch ($queries['page']) {
        ...
        <footer>
          <div class="pull-right">
            Copyright @ 2020 Aplikasi Akademik : Farizi Fathan Pane
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
